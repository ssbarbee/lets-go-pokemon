...
import { EvolutionData, useEvolutionChain } from "@/hooks/useEvolutionChain";
import { Pokemon } from "@/hooks/usePokemonDetails";
import { EvolutionDrawerProps } from "@/components/EvolutionDrawer";
...
jest.mock("./EvolutionDrawer", () => ({
  EvolutionDrawer: ({ evolutions, onClose }: EvolutionDrawerProps) => (
    <div data-testid="evolution-drawer">
      {evolutions.map((evo: EvolutionData) => (
